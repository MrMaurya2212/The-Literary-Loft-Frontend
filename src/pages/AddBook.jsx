...
const AddBook = () => {
  ...
  const  submit= async()=> {
    try{
      if(data.url==="" ||
        ...
        const response= await axios.post("https://the-literary-loft-d64a.onrender.com/api/v1/add-book",data,{headers});
        setData({
          url:"",
          title:"",
          price:"",
  ...
  return (
    <div className='h-[100%] p-0 md:p-4 flex flex-col'>
      <h1 className='tetx-3xl md:text-5xl font-semibold text-zinc-500 mb-8'>
        Add Book
      </h1>
      <div className=' overflow-auto flex-grow p-4 bg-zinc-800 rounded'>
        <div>
